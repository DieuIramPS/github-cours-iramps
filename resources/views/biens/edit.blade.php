                        ...
                        <div class="col-lg-6 mb-3 mb-lg-0">
                            <div class="row">
                                <div class="col-auto">
                                    ...
                                    <input type="text" style="width:150px" class="form-control @error('prix') is-invalid @enderror" id="inputPrix" name="prix" placeholder="Prix en €" value="{{ old('prix', isset($bien) ? str_replace(',' , '', number_format($bien->prix, 2)) : '') }}" {{ $disabled }}>
                                    @error('prix')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
